    ...
    <div class="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 mt-16 text-center md:mt-24 md:grid-cols-2 gap-y-10 gap-x-24">
            <div>
                ...
                <Image class="w-auto h-8 mx-auto mt-6 md:mt-10" src="https://cdn.rareblocks.xyz/collection/celebration/images/testimonials/6/slack.svg" alt="" width={1920} height={1920} />
            </div>
            ...
            <div>
                ...
                <Image class="w-auto h-8 mx-auto mt-6 md:mt-10" src="https://cdn.rareblocks.xyz/collection/celebration/images/testimonials/6/trivago.svg" alt="" width={1920} height={1920} />
            </div>
        </div>
    </div>
</section>
